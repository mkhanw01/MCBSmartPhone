...
public class AddAccount  extends Activity {
    ...
    public void addAccount(View v) {
        ...
        if (editAcno.getText().toString().trim().length() > 0) {

            if (editCno.getText().toString().trim().length() > 0) {
                if (editHolders.getText().toString().trim().length() > 0) {
                    if (editBankName.getText().toString().trim().length() > 0) {
                        if (editBranchName.getText().toString().trim()
                                .length() > 0) {
                            if (editAddress.getText().toString().trim()
                                    .length() > 0) {
                                if (editIFSC.getText().toString()
                                        .trim().length() > 0) {
                                    if (editMICR.toString().trim()
                                            .length() > 0) {
                                        if (editBalance.getText().toString()
                                                .trim().length() > 0) {
                                            if (editRemarks.toString().trim()
                                                    .length() > 0) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Enter the Account Holders..", Toast.LENGTH_SHORT)
                            .show();
                }
            } else {
                Toast.makeText(getApplicationContext(),
                        "Enter the Customer Number..", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(getApplicationContext(),
                    "Enter the Account Number..", Toast.LENGTH_SHORT).show();
        }
